...
<body>
    ...
    <div>
        <table style="width: 400; border: 1; margin-left: auto; margin-right: auto;">
            ...
            <tr>
                <td style="width: 116 ; background-color: #ffc0cb;">Nama Barang</td>
                <td style="width: 165 ; background-color: #ffc0cb">&nbsp;
                    <?php echo "$nama_barang"; ?>
                </td>
            </tr>
            <tr>
                <td style="background-color: #ffc0cb">Harga</td>
                <td style="background-color: #ffc0cb">&nbsp;
                    <?php echo "Rp. " . number_format($harga); ?>
                </td>
            </tr>
            <tr>
                <td style="background-color: #ffc0cb">Quantity</td>
                <td style="background-color: #ffc0cb">&nbsp;
                    <?php echo "$jumlah"; ?>
                </td>
            </tr>
            <tr>
                <td style="background-color: #ffc0cb">Sub Total</td>
                <td style="background-color: #ffc0cb">&nbsp;
                    <?php echo "Rp. " . number_format($subTotal); ?>
                </td>
            </tr>
            <tr>
                <td style="background-color: #ffc0cb">Status</td>
                <td style="background-color: #ffc0cb">&nbsp;
                    <?php echo "$status"; ?>
                </td>
            </tr>
            <tr>
                <td style="background-color: #ffc0cb">Diskon</td>
                <td style="background-color: #ffc0cb">&nbsp;
                    <?php echo "Rp. " . number_format($diskon); ?>
                </td>
            </tr>
            <tr>
                <td style="background-color: #ffc0cb">Ongkos Kirim</td>
                <td style="background-color: #ffc0cb">&nbsp;
            ...
            <tr>
                <td style="background-color: #666666" class="putih"><strong>Total</strong></td>
